...
function getAccounts1() {
    ...
    $.ajax({
        ...
        async: false,
       // traditional: true,
        url: '/AusPak/UniversityOffer/GetAccounts',       
        contentType: 'JSON',
       // data: { startDate: sttDate, endDate: enDate}
        ...
        $.each(item, function (key, value) {
            ...
            totalClosing += Number(value.opening) + Number(value.debit) - Number(value.credit);
...
function GetLedger(code) {
    ...
    $.ajax({
        ...
        async: false,
        // traditional: true,
        url: '/AusPak/UniversityOffer/GetLedgers',
        contentType: 'JSON',
        // data: { startDate: sttDate, endDate: enDate}
...
function GetVoucher(id) {
    ...
    $.ajax({
        ...
        async: false,
        // traditional: true,
        url: '/AusPak/UniversityOffer/GetVouchers',
        contentType: 'JSON',
...
function Track(id) {
    ...
    debugger;
    //window.location.href = "/GL/Voucher/Create/" + id +"";
   // var link = window.location.href + "~/GL/Voucher/Create/" + id ;
