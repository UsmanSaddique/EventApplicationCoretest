...
namespace EventApplicationCore.Utility
{
    public class SD
    {
        ...
        public const string KitchenUser = "OrderCreator";
        public const string FrontDeskUser = "DeliveryPerson";
        public const string CustomerEndUser = "Customer";
        public const string ssShoppingCarCount = "ssCartCount";

		public const string ssCouponCode = "ssCouponCode";

        public const string StatusSubmitted = "Submitted";
        public const string StatusInProcess = "Being Processed";
        public const string StatusReady = "Ready for Deliver";
